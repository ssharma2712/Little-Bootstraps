...
di <- "C:/Users/Administrator/Downloads/Manuscript_Bootstrap/Revised/Empirical_data/SBS/lb_auto_test/mtCDNA.fas"
ct <- "C:/Users/Administrator/Downloads/Manuscript_Bootstrap/Revised/Empirical_data/SBS/lb_auto_test/mtCDNA.nwk"
lb_precision(dirname(di), ".treefile", candidate_tree = ct)
